...
public class BrightnessBar extends BarView {
    ...
    protected RotateLayout getBarLayout() {
        return (RotateLayout) this.mBarAction.findViewById(R.id.brightness_rotate_view);
    }

    protected View getBarParentLayout() {
        return this.mBarAction.findViewById(R.id.brightness);
    }
    ...
    public void releaseBar() {
        if (this.mInitial) {
            ...
            this.mBarAction.updateAllBars(1, getCursorValue());
        }
    }
}
