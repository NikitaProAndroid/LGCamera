...
public class SettingBrightnessBar extends BrightnessBar {
    public SettingBrightnessBar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SettingBrightnessBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SettingBrightnessBar(Context context) {
        super(context);
    }
