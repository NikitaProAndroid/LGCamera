...
public class SettingBeautyshotBar extends BeautyshotBar {
    public SettingBeautyshotBar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SettingBeautyshotBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SettingBeautyshotBar(Context context) {
        super(context);
    }
    ...
    public void startRotation(int degree, boolean animation) {
        if (this.mBarAction != null) {
            this.mBarAction.rotateSettingBar(6, degree);
        }
    }
}
