...
public class SettingZoomBar extends ZoomBar {
    public SettingZoomBar(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public SettingZoomBar(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public SettingZoomBar(Context context) {
        super(context);
    }
    ...
    public void startRotation(int degree, boolean animation) {
        if (this.mBarAction != null) {
            this.mBarAction.rotateSettingBar(4, degree);
        }
    }
}
