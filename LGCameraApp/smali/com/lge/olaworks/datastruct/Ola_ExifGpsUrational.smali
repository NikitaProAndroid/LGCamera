...
.method public constructor <init>(IIIIII)V
    .locals 0
    .param p1, "degree_numerator"    # I
    .param p2, "degree_denominator"    # I
    .param p3, "min_numerator"    # I
    .param p4, "min_denominator"    # I
    .param p5, "sec_numerator"    # I
    .param p6, "sec_denominator"    # I
